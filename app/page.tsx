...
import { Play, Gift, Trophy, Users, LayoutDashboard, TrendingDown, ArrowRight, Shield, Zap, Phone } from "lucide-react"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
            <div>
              ...
              <p className="text-slate-400 text-sm leading-relaxed">
                Aprovado pela SUSEP através do processo indicado na cautela, nos termos da Lei Federal nº 14.332/2022 e
                das Circulares SUSEP nº 656/2022 e 676/2022.
              </p>
            </div>
